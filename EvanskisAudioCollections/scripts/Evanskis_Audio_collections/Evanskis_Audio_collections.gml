function EAC_audio_collection_create(sounds) constructor{
	/// @function EAC_audio_collection_create(sound, sound2, sound3...)
...
function EAC_audio_collection_play(audio_collection, index, priority=1, loops=false, argument_array=pointer_null){
	/// @function EAC_audio_collection_play(audio_collection, index, [priority], [loops], [argument_array])
	/// @desc Plays a sound from the index of the audio collection
	/// @param {array} audio_collection
	/// @param {real} index
...
function EAC_audio_collection_play_all(audio_collection, priority=1, loops=false, argument_array=pointer_null){
	/// @function EAC_audio_collection_play_all(audio_collection, [priority], [loops], [argument_array])
...
function EAC_audio_collection_stop(audio_collection, index){
	/// @function EAC_audio_collection_stop(audio_collection, index)
...
function EAC_audio_collection_stop_all(audio_collection){
	/// @function EAC_audio_collection_stop_all(audio_collection)
